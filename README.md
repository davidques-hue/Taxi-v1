...
## v1.2
- Corrección de etiquetas invisibles/recortadas en botones en Samsung/Android 16.
- Teclado y navegación usan controles de texto clicables con estilo propio, sin depender del estilo nativo de Button.
- Se mantiene el mismo applicationId (`cl.taxicaja.app`) para actualizar sobre la instalación anterior.
